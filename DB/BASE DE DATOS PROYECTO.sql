...
CREATE TABLE EMPLEADOS(
    ...
    CONSTRAINT fk_ID_TIPO_EMPLEADO FOREIGN KEY (ID_TIPO_EMPLEADO) REFERENCES TIPO_USUARIO(ID_TIPO_EMPLEADO)
);
...
CREATE TABLE TIPO_EMPLEADO_EMPLEO(
    ...
    CONSTRAINT fk_TIPO_EMPLEADO FOREIGN KEY (ID_TIPO_EMPLEADO) REFERENCES TIPO_USUARIO(ID_TIPO_EMPLEADO)
);
